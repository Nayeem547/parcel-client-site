...
<p> Delivery </p> <p className="  pl-6 " >Express</p>
                    ...
                    <p>Nayeem Hossain<br />MERN stack Developer</p>
                </div>
                <div>
            ...
            <div className="p-4 footer-center  bg-neutral text-white">
                    <div>
                        <p>Copyright © 2023 - All right reserved by Nayeem Hossain</p>
                    </div>
                </div>
        </footer>
    );
